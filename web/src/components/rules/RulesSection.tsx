...
const RULES = [
  ...
  { n: "03", title: "At zero, it ends forever.", body: "If nobody presses before the deadline, the experiment is over." },
  {
    ...
    body: "The operator may publicly push the clock back to 60 while the experiment is still alive — but nothing, not even the operator, can revive it once it truly ends."
  }
];
